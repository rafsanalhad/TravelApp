...
const NewsLetter = () => {
  return (
    <div className="bg-black pt-16 pb-16 flex items-center justify-center w-full flex-col">
      ...
      <h1 className="text-lg sm:text-xl md:text-2xl text-white font-semibold mt-10 tracing-widest">
        Your Travel Journey Starts Here
      </h1>
      <p className="mt-3 text-white text-xs sm:text-sm">
        Sign up and i'll send the best deals to you
      </p>
      <div className="w-full">
        <input type="text" className="px-6 py-3.5 bg-white mt-8 w-[95%] sm:w-[60%] md:w-[60%] lg:w-[40%] block mx-auto rounded-lg outline-none" placeholder="Email" name="" id="" />
